		...
		$.ajax({
			...
			success : function(msg) {
						...
						case "success": $("#deleteResult").modal('show');
									    $("#resultBtn").attr("href","reservationMgmt"); break;
						};
			}
		});
	});
    ...
    $.ajax({
       ...
       success: function(msg){
			...
			case "success": $("#check").modal('show');
						    $("#confirmBtn").attr("href","reservationMgmt"); break;
...
$("#searchBtn").on("click",function(){
	...
	var carNum=0;
    var reservNum=0;
    console.log($("#sReservDateSearch").val())
    console.log($("#sReturnDateSearch").val())
    

	var res = {
		reservNum:$("#sReservNum").val(),
		userId:$("#sUserId").val(),
		carNum:$("#sCarNum").val(),
	...
	console.log(res);
	console.log(typeof(res.reservDate)+"타입")
	$.ajax({
...
<div id="contentDiv" style="margin-bottom: 0px; margin-left:1px;">
	...
	<form id="searchForm" method="post">
		...
		<input type="text" name="reservNum" id="sReservNum">&nbsp;&nbsp;
		
		<label style="color: black;">아이디</label>&nbsp;&nbsp;
		<input type="text" name="userId" id="sUserId" placeholder="숫자만 입력하세요.">
		
		<label style="color: black;">차량 번호</label>&nbsp;&nbsp;
		<input type="text" name="carNum" id="sCarNum" placeholder="숫자만 입력하세요.">
		
		<br>
		
		<label style="color: black;">차량 이름</label>&nbsp;&nbsp;
		<input type="text" name="carName" id="sCarName" placeholder="숫자만 입력하세요.">
		...
		<a class="btn btn-primary btn-sm" type="button" id="searchBtn">검색</a>
	</form>
	</div>
